...
```powershell
python .\scripts\layout_flowchart_diagram.py `
  .\paper-context\evidence\flowchart-model.json `
  --out .\paper-context\evidence\flowchart-model.positioned.json

python .\scripts\check_flowchart_layout.py `
  .\paper-context\evidence\flowchart-model.positioned.json

powershell -ExecutionPolicy Bypass -File .\scripts\generate_visio_flowchart_diagram.ps1 `
