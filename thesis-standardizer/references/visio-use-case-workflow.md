...
```powershell
python .\thesis-standardizer\scripts\layout_use_case_diagram.py `
  .\paper-context\evidence\use-case-model.json `
  --out .\paper-context\evidence\use-case-model.positioned.json

python .\thesis-standardizer\scripts\check_use_case_layout.py `
  .\paper-context\evidence\use-case-model.positioned.json

powershell -ExecutionPolicy Bypass -File .\thesis-standardizer\scripts\generate_visio_use_case_diagram.ps1 `
