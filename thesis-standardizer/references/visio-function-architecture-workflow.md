...
```powershell
python .\thesis-standardizer\scripts\layout_function_architecture_diagram.py `
...
python .\thesis-standardizer\scripts\check_function_architecture_layout.py `
  .\paper-context\evidence\function-architecture-model.positioned.json

powershell -ExecutionPolicy Bypass -File .\thesis-standardizer\scripts\generate_visio_function_architecture_diagram.ps1 `
